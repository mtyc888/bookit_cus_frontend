...
const Summary = ({ formData, prevStep, setStep, setFormData, business }) => {
    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            const response = await fetch(`http://ec2-3-1-205-2.ap-southeast-1.compute.amazonaws.com:3001/api/bookings`, {
                method: "POST",
                headers: {
            ...
            const emailResponse = await fetch(`http://ec2-3-1-205-2.ap-southeast-1.compute.amazonaws.com:3001/api/notifications/send-mail`, {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                },
